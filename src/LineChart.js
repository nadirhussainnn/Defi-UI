...
export default class LineChart extends Component {
  ...
  makePath() {
    ...
    return (
      <path className="linechart_path" d={pathD} style={{stroke: index%2==0?"#70c040":"#FF0000"}} />
    );
  }
  ...
  render() {
    ...
    return (
      <svg width={"200px"} height={"50px"} viewBox={`0 0 ${svgWidth} ${svgHeight-20}`}>
